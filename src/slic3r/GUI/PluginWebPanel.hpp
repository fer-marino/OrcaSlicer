...
// Plugin HTML in a web view, shared by plugin Pages tabs and docked panels: bootstrap page and swap,
// theme and bridge scripts, live re-theming, and window.orca messages routed to on_page_message().
